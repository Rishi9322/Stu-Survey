...
if ($selectedSurveyId) {
    ...
    $surveyCompleted = isSurveyCompleted($_SESSION["id"], "student", $conn, $selectedSurveyId);
    
    // Get questions for this specific survey
    $questions = getSurveyQuestions("student", $conn, $selectedSurveyId);
...
// Get all teachers for rating (only on survey form view)
$teachers = $selectedSurveyId ? getAllTeachers($conn) : [];

// Get all active surveys for listing
$activeSurveys = getActiveSurveysForRole("student", $_SESSION["id"], $conn);
...
<div class="container py-4">
    ...
    <div class="page-header-modern mb-4">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h1><?php echo $selectedSurvey ? htmlspecialchars($selectedSurvey['title']) : 'Student Surveys'; ?></h1>
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . '?survey_id=' . $selectedSurveyId; ?>" method="post" id="survey-form">
        ...
        <div class="survey-progress mb-4">
            <div class="progress-steps">
                ...
                <div class="step">
                    ...
                    <span class="step-label">Rate Teachers</span>
                </div>
                <div class="step-connector"></div>
                <div class="step">
        ...
        <div class="card-modern mb-4">
            <div class="card-header-modern">
                <h4><i class="fas fa-chalkboard-teacher me-2"></i>Rate Your Teachers</h4>
                <span class="badge bg-primary">Required</span>
            </div>
            <div class="card-body-modern">
                    ...
                    <div class="teacher-card">
                        <div class="teacher-info">
                            ...
                            <div class="teacher-details">
                                ...
                                <p><i class="fas fa-building me-1"></i><?php echo htmlspecialchars($teacher['department']); ?> 
                                   <span class="mx-2">•</span> 
                                   <i class="fas fa-book me-1"></i><?php echo htmlspecialchars($teacher['subjects']); ?></p>
                            </div>
                        </div>
                        <div class="rating-cards mt-3">
                            <label class="rating-card bad">
                                <input type="radio" name="teacher[<?php echo $teacher['id']; ?>]" value="bad" required>
                                <div class="card-inner">
                                    <i class="fas fa-frown"></i>
                                    <span>Bad</span>
                                </div>
                            ...
                            <label class="rating-card neutral">
                                <input type="radio" name="teacher[<?php echo $teacher['id']; ?>]" value="neutral" required>
                                <div class="card-inner">
                                    <i class="fas fa-meh"></i>
                                    <span>Neutral</span>
                                </div>
                            ...
                            <label class="rating-card good">
                                <input type="radio" name="teacher[<?php echo $teacher['id']; ?>]" value="good" required>
                                <div class="card-inner">
                                    <i class="fas fa-smile"></i>
                                    <span>Good</span>
                                </div>
                        ...
                        <div class="mt-3">
                            <textarea class="form-control" name="teacher_comment[<?php echo $teacher['id']; ?>]" rows="2" 
                                placeholder="Optional: Share your comments about this teacher..."></textarea>
                        </div>
                    </div>
                    <?php endforeach; ?>
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <p>No teachers are available for rating at the moment.</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
                    ...
                    <div class="col-md-6">
                        <div class="feedback-box suggestion">
                            ...
                            <textarea class="form-control" id="suggestion" name="suggestion" rows="4" 
                                placeholder="Share your ideas to improve our college..."></textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
...
.teacher-details h5 { margin: 0 0 0.25rem 0; font-weight: 600; }
.teacher-details p { margin: 0; color: var(--text-muted); font-size: 0.875rem; }
